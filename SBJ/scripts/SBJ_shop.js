function Shop(gD, menu) {
  ...
  this.init = function() {
    ...
    for (var i = 0; i < 3; i++) {
      this.buttons.push(new MenuButton((this.gD.canvas.width / 2) - 290 + (i * 200), 245, 180, 20, "11pt", "Showcard Gothic", "rgba(255, 255, 255, 1)", "Kaufen", "rgba(0, 0, 0, .6)", 2));
    }
    ...
    for (var i = 0; i < this.gD.itemProb.length; i++) {
      this.buttons.push(new MenuButton((this.gD.canvas.width / 2) - 290 + (i * 120), 200, 100, 20, "11pt", "Showcard Gothic", "rgba(255, 255, 255, 1)", "Upgrade", "rgba(0, 0, 0, .6)", 2));
      this.buttons.push(new MenuButton((this.gD.canvas.width / 2) - 290 + (i * 120), 245, 100, 20, "11pt", "Showcard Gothic", "rgba(255, 255, 255, 1)", "Downgrade", "rgba(0, 0, 0, .6)", 2));
    }
    for (var i = 0; i < this.gD.itemProb.length; i++) {
